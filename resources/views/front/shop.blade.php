                                        ...
                                        <div class="accordion-item">
                                            ...
                                            @else
                                                <a href="{{ route('front.shop', $category->slug) }}"
                                                    class="nav-item nav-link {{ $categorySelected == $category->id ? 'text-info' : '' }}">{{ $category->name }}</a>
                                            @endif
                                                        ...
                                                        <div class="navbar-nav">
                                                            ...
                                                            @foreach ($category->sub_category as $subCategory)
                                                                <a href="{{ route('front.shop', [$category->slug, $subCategory->slug]) }}"
                                                                    class="nav-item nav-link {{ $subCategorySelected == $subCategory->id ? 'text-info' : '' }}">{{ $subCategory->name }}</a>
                                                            @endforeach
                                    ...
                                    <div class="card product-card">
                                        <div class="product-image position-relative">
                                            <a href="{{route('front.product',$product->slug)}}" class="product-img">
                                                ...
                                                @else
                                                    <img class="card-img-top"
                                                        src="{{ asset('assets/img/default-150x150.png') }}" alt="">
                                                @endif
                                            </a>
...
@section('customJs')
    <script>
        ...
        var silder = $(".js-range-slider").data("ionRangeSlider");
        ...
        function apply_filters() {
            ...
            //price filter
            url += '&price_min=' + silder.result.from + '&price_max=' + silder.result.to;
            //sorting
            url += '&sort=' + $('#sort').val();
