                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3"><input type="text" name="amount" id="amount" class="form-control"
                                        placeholder="Amount">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3"><button type="submit" class="btn btn-primary">Create</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                @if ($shippingCharges->isNotEmpty())
                                    @foreach ($shippingCharges as $shippingCharge)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('shippings.edit', $shippingCharge->id) }}"
...
@section('customJs')
    <script>
        ...
        function deleteRecord(id) {
            ...
            if (confirm('Are you sure you want to delete this shipping management')) {
                $.ajax({
                    url: newUrl,
                    type: 'delete',
                    data: {},
